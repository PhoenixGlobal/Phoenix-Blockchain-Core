...
class Fp6 private[zksnark](var a: Fp2, var b: Fp2, var c: Fp2) extends Field[Fp6] {
  ...
  override def dbl: Fp6 = this.add(this)

  override def mul(o: Fp6): Fp6 = {
    val a1 = a
    val b1 = b
    val c1 = c
    val a2 = o.a
  ...
  private[zksnark] def mulByNonResidue = {
  ...
  override def negate = new Fp6(a.negate, b.negate, c.negate)

  override def isZero: Boolean = this == Fp6.ZERO

  override def isValid: Boolean = a.isValid && b.isValid && c.isValid
  ...
  override def equals(o: Any): Boolean = {
    ...
    if (!o.isInstanceOf[Fp6]) return false
    val fp6 = o.asInstanceOf[Fp6]
    if (if (a != null) !(a == fp6.a)
    else fp6.a != null) return false
    if (if (b != null) !(b == fp6.b)
    else fp6.b != null) return false
    //return !(c != null ? !c.equals(fp6.c) : fp6.c != null);
    if (if (c != null) !(c == fp6.c)
    else fp6.c != null) return false
    true
  }
}
